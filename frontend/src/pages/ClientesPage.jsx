  ...
  return (
    <PageWrapper>
      <div className="max-w-4xl mx-auto space-y-6">
        ...
        {/* ✅ CREAR */}
        {vista === "crear" && <ClienteForm />}

        {/* ✅ LISTA */}
        {vista === "lista" && !clienteSeleccionado && (

          <div className="space-y-5 bg-white p-6 rounded-2xl shadow-md border border-gray-200">
            ...
            {clientesFinal.length === 0 ? (
              ...
              <div className="space-y-5">
                <ClienteList
                  ...
                  onEditarClick={(c) => setClienteEditando(c)}
                />
              </div>
            )}
